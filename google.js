...
let ReservaDiv=document.querySelector('Seleccion')
 ...
 // Asignamos el evento click del marcador
   google.maps.event.addListener(marker, 'click', function() {
     ...
     setTimeout (dibujar(place), 4000);//Aca se puede poner una funcion de espera 
   });
}

function dibujar(place){  
...
/*
    ...
    dibujo.innerHTML=`<h1>HOLA MUNDO</h1>
